...
import Film from "@/components/Films/index.vue";
import FocusAdv from "@/pages/Home/FocusAdv/index.vue";
import FootAdv from "@/pages/Home/FootAdv/index.vue";
import Floors from "@/pages/Home/Floors/index.vue";
import {mapActions} from "vuex";
import Rank from "@/pages/Home/Rank/index.vue";

export default defineComponent({
  name: "index",
  components: {Rank, Floors, FootAdv, FocusAdv},
  methods:{
    ...mapActions('focus',['getFloorList'])
  },
  mounted(){
    this.getFloorList();
  }
...
<!--   <Film></Film>-->
   ...
   <Floors v-for="item in $store.state.focus.floorsList" :key="item.id" :floorInfo="item"></Floors>
