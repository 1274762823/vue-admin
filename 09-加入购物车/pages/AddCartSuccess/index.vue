...
export default defineComponent({
  ...
  data(){
    return{
      //从会话存储空间获取商品详情
      cartInfo:sessionStorage.getItem('addCartInfo')?
      ...
      <div class="goods">
        <div class="left-good">
          ...
          <div class="right-info">
            ...
            <p>购买数量:{{cartInfo.buyNum}}</p>
          </div>
        </div>
        <div class="right-gocart">
          <a @click="$router.push('/details/'+cartInfo.id+'.html')" href="#" class="sui-btn btn-xlarge">查看商品详情</a>
